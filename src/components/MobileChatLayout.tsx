...
import FriendSidebarOptions from './FriendSidebarOptions'
...
const MobileChatLayout: FC<MobileChatLayoutProps> = ({ friends, session, sidebarOptions, unseenRequestCount }) => {
  ...
  return (
    <div className='fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 z-[90] px-4'>
      <div className='w-full flex justify-between items-center'>
        <Link
          href='/dashboard'
        >
          <SendHorizonal className='h-6 w-auto text-indigo-600' />
        </Link>
